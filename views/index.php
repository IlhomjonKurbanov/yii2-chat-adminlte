<div class="box box-success">
    ...
    <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 350px;">
        <div id="chat-box" class="box-body2 chat2" style="overflow: auto; width: auto; height: 350px;">
    ...
    <div class="box-footer" style="margin-top:20px;border-top:1px solid">
        <div class="input-group">
            ...
            <div class="input-group-btn">
                <button class="btn btn-success btn-send-comment" data-url="<?=$url;?>"  data-chatid="<?=$chatId;?>"><i class="fa fa-plus"></i> Отправить</button>
            </div>
        </div>
    </div>
</div><!-- /.box (chat box) -->